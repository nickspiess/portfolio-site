...
import styles from './styles/PostCardCategory.module.css';

const PostCardCategory = ({ post }) => {

  return (
    <div className={`${styles.postsContainerSlug} bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8`}>
