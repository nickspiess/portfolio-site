...
const AboutMe = () => {
  return (
    <div className={styles.aboutMe}>
      ...
      <p className={styles.description}>I've been working in software and IT for over half a decade and I love it.  I believe that technologies' potential is only limited to our creative capacity and that these tools can enable us and provide value in ways we haven't dreamed of yet.</p>
