...
const AboutLanding = () => {
  return (
    <section className={styles.aboutSection}>
      ...
      <p className={styles.aboutDescription}>We are more than just a web solutions provider, are your end-to-end partner in establishing a formidable digital footprint, encompassing everything from web and mobile development to cloud solutions and SEO strategies.</p>
